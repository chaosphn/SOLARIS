...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to the hash-based login route /#/login so the SPA can render the login form.
        await page.goto("http://localhost:4200/#/login")
        
        # -> Fill username and password then submit the login form by clicking the LOGIN button.
        ...
        frame = context.pages[-1]
        assert await frame.locator("xpath=//*[contains(., 'Configuration saved successfully')]").nth(0).is_visible(), "The site billing configuration should show a success confirmation after saving."
