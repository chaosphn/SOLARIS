...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to the hash-based login page at http://localhost:4200/#/login and wait for the UI to render.
        await page.goto("http://localhost:4200/#/login")
        
        # -> Fill the username and password, then submit the login form to authenticate as admin.
        ...
        frame = context.pages[-1]
        assert await frame.locator("xpath=//*[contains(., 'Test User A')]").nth(0).is_visible(), "The user list should show Test User A after creating the new user."
