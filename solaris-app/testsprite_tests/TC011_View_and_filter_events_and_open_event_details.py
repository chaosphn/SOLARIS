...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to the hash-based login route at '/#/login' and wait for the SPA to load so the login form and interactive elements appear.
        await page.goto("http://localhost:4200/#/login")
        
        # -> Fill the username and password fields and submit the login form to authenticate.
        ...
        frame = context.pages[-1]
        assert await frame.locator("xpath=//*[contains(., 'Event Details')]").nth(0).is_visible(), "The Event Details heading should be visible after opening an event in the filtered list."
