...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to the login route at http://localhost:4200/#/login so the app can render the login form.
        await page.goto("http://localhost:4200/#/login")
        
        # -> Fill the username and password fields and submit the login form (use satadmin / satsat1234).
        ...
        frame = context.pages[-1]
        assert await frame.locator("xpath=//*[contains(., 'At-time snapshot')]").nth(0).is_visible(), "The charts page should display the At-time snapshot results after requesting an at-time snapshot"
