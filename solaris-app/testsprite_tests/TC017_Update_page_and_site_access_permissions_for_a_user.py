...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to the login route at /#/login so the SPA can attempt to render the login UI.
        await page.goto("http://localhost:4200/#/login")
        
        # -> Fill the username and password fields and submit the login form to authenticate as the admin user (use satadmin / satsat1234).
        ...
        frame = context.pages[-1]
        assert await frame.locator("xpath=//*[contains(., 'Site Access')]").nth(0).is_visible(), "The updated page and site permissions should still be selected after reopening the user edit view."
