...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to the hash-based login page at /#/login to load the application login UI.
        await page.goto("http://localhost:4200/#/login")
        
        # -> Enter credentials into the username and password fields and click the LOGIN button to sign in as the billing operator.
        ...
        frame = context.pages[-1]
        assert await frame.locator("xpath=//*[contains(., 'Completed')]").nth(0).is_visible(), "The billing record should be marked Completed after verifying the payment proof and issuing the receipt."
