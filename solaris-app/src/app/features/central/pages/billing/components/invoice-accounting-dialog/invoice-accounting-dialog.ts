...
@Component({
  selector: 'app-invoice-accounting-dialog',
  standalone: false,
  templateUrl: './invoice-accounting-dialog.html',
  styleUrl: './invoice-accounting-dialog.scss'
})
export class InvoiceAccountingDialog implements OnInit {
  ...
  private dialogRef  = inject(MatDialogRef<InvoiceAccountingDialog>);
